...
@section('content')
<div class="mb-4"><h1 class="h3 mb-0">Add Video Category</h1></div>
<div class="card shadow-sm"><div class="card-body">
<form action="{{ route('admin.video-categories.store') }}" method="POST">@csrf
    ...
    <button type="submit" class="btn btn-maroon">Create</button> <a href="{{ route('admin.video-categories.index') }}" class="btn btn-outline-secondary">Cancel</a>
</form></div></div>
@endsection
